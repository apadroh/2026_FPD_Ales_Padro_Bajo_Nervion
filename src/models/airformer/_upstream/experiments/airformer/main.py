...
def get_config():
    ...
    parser.add_argument('--datapath', type=str, default=None,
                        help='Override data dir (train/val/test.npz)')
    parser.add_argument('--graph_pkl', type=str, default=None,
                        help='Override adjacency pickle path')
    parser.add_argument('--log_dir', type=str, default=None,
                        help='Override log/checkpoint directory')
    parser.add_argument('--peak_weight_alpha', type=float, default=0.0,
                        help='Train-only: extra MAE weight for high PM10 labels')
    parser.add_argument('--peak_weight_thr', type=float, default=40.0)
    parser.add_argument('--peak_weight_thr2', type=float, default=80.0)
    parser.add_argument('--peak_asym_beta', type=float, default=0.0,
                        help='Train-only: extra weight when under-predicting')
    parser.add_argument('--train_loss', type=str, default='mae',
                        choices=['mae', 'mse'],
                        help='Masked loss for train/val (default mae; official ZONE2 runs)')
...
def main():
    ...
    trainer = Trainer(model=model,
                      ...
                      peak_weight_thr=args.peak_weight_thr,
                      peak_weight_thr2=args.peak_weight_thr2,
                      peak_asym_beta=args.peak_asym_beta,
